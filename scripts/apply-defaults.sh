...
# Fast key repeat (lower = faster; min is 1)
...
# Minimise windows using the scale effect (faster)
...
echo "▶ Restarting affected apps to apply settings..."
for app in "Finder" "Dock" "Safari" "SystemUIServer" "cfprefsd"; do
